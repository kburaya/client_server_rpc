...
ip netns exec ns1 ./CLI_SERV_SOURCE/rpc_server srvns1 service_1 tcp
sleep 3
./CLI_SERV_SOURCE/rpc_client 192.168.16.135 service_1 "agent1 to service_1 from srvns1"

ip netns exec ns2 ./CLI_SERV_SOURCE/rpc_server srvns2 service_2 tcp
sleep 3
...
sleep 3
./CLI_SERV_SOURCE/rpc_client 192.168.16.135 service_3 tcp "agent3 to service_3 from srvns3"
