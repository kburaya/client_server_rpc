...
echo "Rpcinfo in ns1 output"
ip netns exec ns1 rpcinfo -s
echo "Rpcinfo in ns2 output"
...
./CLI_SERV_SOURCE/rpc_client 192.168.16.136 service_1 "client from ns2 - service_1" $2
...
./CLI_SERV_SOURCE/rpc_client 192.168.16.135 service_2 "client from ns1 - service_2" $2
./CLI_SERV_SOURCE/rpc_client 192.168.16.136 service_1 "client from ns2 - service_1" $2
...
./CLI_SERV_SOURCE/rpc_client 192.168.16.135 service_2 "client from ns1 - service_2" $2
./CLI_SERV_SOURCE/rpc_client 192.168.16.135 service_2 "client from ns1 - service_3" $2
